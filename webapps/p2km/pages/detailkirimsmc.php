                                ...
                                <?php
                                    ...
                                    if (!$baris) {
                                        $baris = mysqli_fetch_array(bukaquery(<<<SQL
                                            ...
                                            (select inacbg_pasien_tb_smc.no_sitb from inacbg_pasien_tb_smc where inacbg_pasien_tb_smc.no_rkm_medis = reg_periksa.no_rkm_medis limit 1) as no_sitb,
                                ...
                                if ((!empty($norawat)) && (!empty($nosep)) && (!empty($nokartu))) {
                                    ...
                                    if ($success === true) {
                                        ['success' => $success, 'data' => $response, 'error' => $error] = UpdateDataKlaimSmc(
                                            ...
                                            $nm_dokter, getKelasRS(), "79", "JKB", "#", $codernik
                                        );
                                    }
