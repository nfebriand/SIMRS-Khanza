...
/**
 * RL 2 — Meta Ketenagaan / SISDMK (entry-display, read-only).
 * Menampilkan singleton sirs_rl2_meta (id=1) apa adanya sebagai tabel
 * Field|Nilai. Tidak bergantung tanggal: param tgl1/tgl2 diabaikan.
 * Tabel Khanza read-only — hanya SELECT, tidak menulis.
 */
public class Rl2 implements SirsBuilder {
    ...
    public SirsResult build(Connection k, String tgl1, String tgl2) throws Exception {
        ...
        String sql = "SELECT * FROM sirs_rl2_meta WHERE id=1";
