...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    */
    ...
    // ==================================================================================================================
    // == METODE prosesCari() DIMODIFIKASI (KEMBALI MENGHITUNG MATI) ==
    // ==================================================================================================================
    private void prosesCari() {
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        try {
            htmlContent = new StringBuilder();
            // Membuat Header Tabel HTML Baru (Mirip RL4A tapi judul kolom beda)
            htmlContent.append(
                "<tr class='isi'>"+
            ...
            try {
                 // Parameter setting untuk query utama (Dipertahankan dari DlgRL4BSebab.java ASLI)
                ...
                while(rs.next()){
                    ...
                    // Query Pasien per Diagnosa (Dipertahankan dari DlgRL4BSebab.java ASLI)
                    ps2=koneksi.prepareStatement(
                            ...
                            "":"and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? "));
                    try {
                        // Parameter setting untuk query ps2 (Dipertahankan dari DlgRL4BSebab.java ASLI)
                        if(nmpoli.getText().trim().equals("")&&nmdokter.getText().trim().equals("")&&nmpenjab.getText().trim().equals("")&&nmkabupaten.getText().trim().equals("")&&nmkecamatan.getText().trim().equals("")&&nmkelurahan.getText().trim().equals("")){
                    ...
                    // Membuat Baris Data HTML Baru (Menampilkan Hidup & Mati)
                     htmlContent.append("<tr class='isi'>");
