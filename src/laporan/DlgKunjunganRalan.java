        ...
        try {
            ...
            if(TabRawat.getSelectedIndex()==0){
                if(tabMode.getRowCount()==0){
                    ...
                    switch (pilihan) {
                        case "Laporan 1 (HTML)":
                            Valid.exportHtmlSmc("SurveilansRalan.html", "Surveilans PD3I", table1);
                            break;
                        case "Laporan 2 (WPS)":
                            Valid.exportWPSSmc("SurveilansRalan.wps", "Surveilans PD3I", table1);
                            break;
                        case "Laporan 3 (CSV)":
                            Valid.exportCSVSmc("SurveilansRalan.csv", table1);
                            break;
                        case "Laporan 4 (XLSX)":
                            Valid.exportXlsxSmc("SurveilansRalan.xlsx", table1);
                            break;
