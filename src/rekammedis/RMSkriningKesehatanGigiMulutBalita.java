    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataSkriningKesehatanGigiMulutBalita.html", "DATA SKRINING KESEHATAN GIGI & MULUT BALITA", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataSkriningKesehatanGigiMulutBalita.wps", "DATA SKRINING KESEHATAN GIGI & MULUT BALITA", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataSkriningKesehatanGigiMulutBalita.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataSkriningKesehatanGigiMulutBalita.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
