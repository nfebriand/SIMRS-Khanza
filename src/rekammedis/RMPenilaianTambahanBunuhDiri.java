    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataPenilaianTambahanBunuhDiri.html", "DATA PENGKAJIAN TAMBAHAN BUNUH DIRI", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataPenilaianTambahanBunuhDiri.wps", "DATA PENGKAJIAN TAMBAHAN BUNUH DIRI", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataPenilaianTambahanBunuhDiri.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataPenilaianTambahanBunuhDiri.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
