    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataCatatanPengkajianPaskaOperasi.html", "DATA CATATAN PENGKAJIAN PASKA OPERASI", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataCatatanPengkajianPaskaOperasi.wps", "DATA CATATAN PENGKAJIAN PASKA OPERASI", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataCatatanPengkajianPaskaOperasi.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
