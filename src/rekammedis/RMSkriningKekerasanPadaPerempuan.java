    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataSkriningKekerasanPadaPerempuan.html", "DATA SKRINING KEKERASAN PADA PEREMPUAN", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataSkriningKekerasanPadaPerempuan.wps", "DATA SKRINING KEKERASAN PADA PEREMPUAN", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataSkriningKekerasanPadaPerempuan.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataSkriningKekerasanPadaPerempuan.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
