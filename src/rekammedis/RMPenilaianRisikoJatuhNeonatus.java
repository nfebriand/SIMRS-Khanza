    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataPenilaianRisikoJatuhNeonatus.html", "DATA PENGKAJIAN LANJUTAN RISIKO JATUH NEONATUS", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataPenilaianRisikoJatuhNeonatus.wps", "DATA PENGKAJIAN LANJUTAN RISIKO JATUH NEONATUS", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataPenilaianRisikoJatuhNeonatus.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataPenilaianRisikoJatuhNeonatus.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
