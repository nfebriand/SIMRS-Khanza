    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataPenilaianTambahanPerilakuKekerasan.html", "DATA PENGKAJIAN TAMBAHAN PERILAKU KEKERASAN", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataPenilaianTambahanPerilakuKekerasan.wps", "DATA PENGKAJIAN TAMBAHAN PERILAKU KEKERASAN", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataPenilaianTambahanPerilakuKekerasan.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataPenilaianTambahanPerilakuKekerasan.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
