    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataPenilaianPasienPenyakitMenular.html", "DATA PENGKAJIAN PASIEN PENYAKIT MENULAR", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataPenilaianPasienPenyakitMenular.wps", "DATA PENGKAJIAN PASIEN PENYAKIT MENULAR", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataPenilaianPasienPenyakitMenular.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataPenilaianPasienPenyakitMenular.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
