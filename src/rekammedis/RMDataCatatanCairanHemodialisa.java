    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataCatatanCairanHemodialisa.html", "DATA CATATAN CAIRAN HEMODIALISA", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataCatatanCairanHemodialisa.wps", "DATA CATATAN CAIRAN HEMODIALISA", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataCatatanCairanHemodialisa.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
