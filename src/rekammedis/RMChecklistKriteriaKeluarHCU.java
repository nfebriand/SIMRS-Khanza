    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataChecklistKriteriaKeluarHCU.html", "DATA CHECK LIST KRITERIA KELUAR HCU", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataChecklistKriteriaKeluarHCU.wps", "DATA CHECK LIST KRITERIA KELUAR HCU", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataChecklistKriteriaKeluarHCU.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataChecklistKriteriaKeluarHCU.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
