    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataSkriningKesehatanPenglihatan.html", "DATA SKRINING KESEHATAN PENGLIHATAN", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataSkriningKesehatanPenglihatan.wps", "DATA SKRINING KESEHATAN PENGLIHATAN", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataSkriningKesehatanPenglihatan.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
