    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataSkriningRisikoKankerServiks.html", "DATA SKRINING RISIKO KANKER SERVIKS", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataSkriningRisikoKankerServiks.wps", "DATA SKRINING RISIKO KANKER SERVIKS", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataSkriningRisikoKankerServiks.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
