    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataSkriningMerokokUsiaSekolahRemaja.html", "DATA SKRINING PERILAKU MEROKOK BAGI USIA SEKOLAH DAN REMAJA", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataSkriningMerokokUsiaSekolahRemaja.wps", "DATA SKRINING PERILAKU MEROKOK BAGI USIA SEKOLAH DAN REMAJA", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataSkriningMerokokUsiaSekolahRemaja.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataSkriningMerokokUsiaSekolahRemaja.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
