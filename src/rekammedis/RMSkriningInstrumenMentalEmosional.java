    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataSkriningInstrumenMentalEmosional.html", "DATA SKRINING INSTRUMEN MENTAL EMOSIONAL", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataSkriningInstrumenMentalEmosional.wps", "DATA SKRINING INSTRUMEN MENTAL EMOSIONAL", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataSkriningInstrumenMentalEmosional.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataSkriningInstrumenMentalEmosional.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
