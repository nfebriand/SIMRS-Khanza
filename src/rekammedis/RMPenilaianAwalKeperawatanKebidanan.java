            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        ...
                        break;
                    case "Laporan 2 (HTML)":
                        Valid.exportHtmlSmc("DataPenilaianAwalKeperawatanKebidanan.html", "DATA PENGKAJIAN AWAL RAWAT JALAN KEBIDANAN & KANDUNGAN", tbObat);
                        break;
                    case "Laporan 3 (WPS)":
                        Valid.exportWPSSmc("DataPenilaianAwalKeperawatanKebidanan.wps", "DATA PENGKAJIAN AWAL RAWAT JALAN KEBIDANAN & KANDUNGAN", tbObat);
                        break;
                    case "Laporan 4 (CSV)":
                        Valid.exportCSVSmc("DataPenilaianAwalKeperawatanKebidanan.csv", tbObat);
                        break;
                    case "Laporan 5 (XLSX)":
                        Valid.exportXlsxSmc("DataPenilaianAwalKeperawatanKebidanan.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
