    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataPenilaianAwalMedisRalanTHT.html", "DATA PENGKAJIAN AWAL MEDIS RAWAT JALAN TELINGA, KULIT, DAN TENGGOROKAN", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataPenilaianAwalMedisRalanTHT.wps", "DATA PENGKAJIAN AWAL MEDIS RAWAT JALAN TELINGA, KULIT, DAN TENGGOROKAN", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataPenilaianAwalMedisRalanTHT.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataPenilaianAwalMedisRalanTHT.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
