    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataDokumentasiTindakanESWL.html", "DATA DOKUMENTASI TINDAKAN ESWL", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataDokumentasiTindakanESWL.wps", "DATA DOKUMENTASI TINDAKAN ESWL", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataDokumentasiTindakanESWL.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataDokumentasiTindakanESWL.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
