    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataPenilaianLevelKecemasanRanapAnak.html", "DATA PENGKAJIAN LEVEL KECEMASAN PASIEN RAWAT INAP ANAK", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataPenilaianLevelKecemasanRanapAnak.wps", "DATA PENGKAJIAN LEVEL KECEMASAN PASIEN RAWAT INAP ANAK", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataPenilaianLevelKecemasanRanapAnak.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataPenilaianLevelKecemasanRanapAnak.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
