    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataLaporanPemantauanAnestesi.html", "DATA LAPORAN PEMANTAUAN ANESTESI", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataLaporanPemantauanAnestesi.wps", "DATA LAPORAN PEMANTAUAN ANESTESI", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataLaporanPemantauanAnestesi.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataLaporanPemantauanAnestesi.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
