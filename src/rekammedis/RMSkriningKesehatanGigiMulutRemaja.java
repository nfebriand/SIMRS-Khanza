    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataSkriningKesehatanGigiMulutRemaja.html", "DATA SKRINING KESEHATAN GIGI & MULUT REMAJA & SEKOLAH", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataSkriningKesehatanGigiMulutRemaja.wps", "DATA SKRINING KESEHATAN GIGI & MULUT REMAJA & SEKOLAH", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataSkriningKesehatanGigiMulutRemaja.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataSkriningKesehatanGigiMulutRemaja.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
