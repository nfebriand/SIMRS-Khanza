    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataChecklistPemberianFibrinolitik.html", "DATA CHECKLIST PEMBERIAN FIBRINOLITIK", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataChecklistPemberianFibrinolitik.wps", "DATA CHECKLIST PEMBERIAN FIBRINOLITIK", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataChecklistPemberianFibrinolitik.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataChecklistPemberianFibrinolitik.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
