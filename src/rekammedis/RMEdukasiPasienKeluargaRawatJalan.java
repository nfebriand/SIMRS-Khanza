    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataEdukasiPasienKeluargaRawatJalan.html", "DATA EDUKASI PASIEN DAN KELUARGA TERINTEGRASI RAWAT JALAN", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataEdukasiPasienKeluargaRawatJalan.wps", "DATA EDUKASI PASIEN DAN KELUARGA TERINTEGRASI RAWAT JALAN", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataEdukasiPasienKeluargaRawatJalan.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
