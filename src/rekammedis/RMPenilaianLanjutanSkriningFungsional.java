    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("PenilaianLanjutanSkriningFungsional.html", "DATA PENGKAJIAN LANJUTAN SKRINING FUNGSIONAL", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("PenilaianLanjutanSkriningFungsional.wps", "DATA PENGKAJIAN LANJUTAN SKRINING FUNGSIONAL", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("PenilaianLanjutanSkriningFungsional.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("PenilaianLanjutanSkriningFungsional.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
