    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataPenilaianAwalMedisRalanBedahMulut.html", "DATA PENGKAJIAN AWAL MEDIS RAWAT JALAN BEDAH MULUT", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataPenilaianAwalMedisRalanBedahMulut.wps", "DATA PENGKAJIAN AWAL MEDIS RAWAT JALAN BEDAH MULUT", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataPenilaianAwalMedisRalanBedahMulut.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataPenilaianAwalMedisRalanBedahMulut.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
