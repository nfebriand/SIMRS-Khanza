    ...
    private void BtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCetakActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataPermintaanLayananProgramKFR.html", "DATA PERMINTAAN LAYANAN PROGRAM KFR", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataPermintaanLayananProgramKFR.wps", "DATA PERMINTAAN LAYANAN PROGRAM KFR", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataPermintaanLayananProgramKFR.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
