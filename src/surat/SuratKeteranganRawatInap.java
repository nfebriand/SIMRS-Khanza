...
public final class SuratKeteranganRawatInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-08-2023" }));
        ...
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-08-2023" }));
    ...
    private void MnCetakSuratRawatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratRawatActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("bangsal",Sequel.cariIsi("select nm_bangsal from bangsal inner join kamar on kamar.kd_bangsal=bangsal.kd_bangsal inner join kamar_inap on kamar_inap.kd_kamar=kamar.kd_kamar where kamar_inap.no_rawat=?",TNoRw.getText()));
                param.put("namars",akses.getnamars());
                param.put("alamatrs",akses.getalamatrs());
                param.put("kotars",akses.getkabupatenrs());
                param.put("propinsirs",akses.getpropinsirs());
