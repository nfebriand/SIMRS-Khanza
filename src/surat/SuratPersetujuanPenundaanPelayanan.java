    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataPersetujuanPenundaanPelayanan.html", "DATA PERSETUJUAN PENUNDAAN PELAYANAN", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataPersetujuanPenundaanPelayanan.wps", "DATA PERSETUJUAN PENUNDAAN PELAYANAN", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataPersetujuanPenundaanPelayanan.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataPersetujuanPenundaanPelayanan.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
