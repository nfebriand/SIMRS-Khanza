    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataPersetujuanRawatInap.html", "DATA PERSETUJUAN MASUK RAWAT INAP", tbObat);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataPersetujuanRawatInap.wps", "DATA PERSETUJUAN MASUK RAWAT INAP", tbObat);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataPersetujuanRawatInap.csv", tbObat);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DataPersetujuanRawatInap.xlsx", tbObat);
                        break;
                }
            } catch (Exception e) {
