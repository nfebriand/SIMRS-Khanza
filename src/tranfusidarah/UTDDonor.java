    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabModeTranfusi.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DonorDarah.html", "Data Donor Darah", tbTranfusiDarah);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DonorDarah.wps", "Data Donor Darah", tbTranfusiDarah);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DonorDarah.csv", tbTranfusiDarah);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("DonorDarah.xlsx", tbTranfusiDarah);
                        break;
