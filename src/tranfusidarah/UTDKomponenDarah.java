    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabModeKomponen.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("KomponenDarah.html", "Data Komponen Darah", tbKomponen);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("KomponenDarah.wps", "Data Komponen Darah", tbKomponen);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("KomponenDarah.csv", tbKomponen);
                        break;
                    case "Laporan 4 (XLSX)":
                        Valid.exportXlsxSmc("KomponenDarah.xlsx", tbKomponen);
                        break;
