    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("DataSirkulasiCSSD.html", "Data Sirkulasi CSSD", tbKamIn);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("DataSirkulasiCSSD.wps", "Data Sirkulasi CSSD", tbKamIn);
                        break;
                    case "Laporan 3 (CSV)":
                        Valid.exportCSVSmc("DataSirkulasiCSSD.csv", tbKamIn);
                        break;
                    case "Laporan 4 (XLSX)":
