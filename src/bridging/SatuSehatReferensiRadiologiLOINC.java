...
public final class SatuSehatReferensiRadiologiLOINC extends javax.swing.JDialog {
        ...
        if (!ceksukses) {
            ...
            new SwingWorker<Void, Object[]>() {
                ...
                protected Void doInBackground() throws Exception {
                    File file = new File("./cache/satusehatradiologiloinc.iyem");
                    file.createNewFile();
                    try (FileWriter fw = new FileWriter(file); ResultSet rs = koneksi.createStatement().executeQuery("select s.code, s.system, s.display from satu_sehat_referensi_radiologi_loinc s")) {
                ...
                protected void done() {
                    ...
                    SatuSehatReferensiRadiologiLOINC.this.setCursor(Cursor.getDefaultCursor());
                    ceksukses = false;
                }
            }.execute();
        }
    ...
    private void tampil2() {
        if (new File("./cache/satusehatradiologiloinc.iyem").isFile()) {
            if (!ceksukses) {
                ceksukses = true;
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                Valid.tabelKosongSmc(tabMode);
                ...
                new SwingWorker<Void, Object[]>() {
                    ...
                    @Override
                    protected Void doInBackground() throws Exception {
                        try (FileReader fr = new FileReader("./cache/satusehatradiologiloinc.iyem")) {
                            if (cari.isBlank()) {
