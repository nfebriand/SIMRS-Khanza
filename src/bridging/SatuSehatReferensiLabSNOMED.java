...
public final class SatuSehatReferensiLabSNOMED extends javax.swing.JDialog {
        ...
        if (!ceksukses) {
            ...
            new SwingWorker<Void, Object[]>() {
                ...
                protected Void doInBackground() throws Exception {
                    ...
                    file.createNewFile();
                    try (FileWriter fw = new FileWriter(file); ResultSet rs = koneksi.createStatement().executeQuery("select s.code, s.system, s.display from satu_sehat_referensi_lab_snomed s")) {
                ...
                protected void done() {
                    ...
                    SatuSehatReferensiLabSNOMED.this.setCursor(Cursor.getDefaultCursor());
                    ceksukses = false;
                }
            }.execute();
        }
    ...
    private void tampil2() {
        if (new File("./cache/satusehatreferensilabsnomed.iyem").isFile()) {
            if (!ceksukses) {
                ceksukses = true;
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                Valid.tabelKosongSmc(tabMode);
