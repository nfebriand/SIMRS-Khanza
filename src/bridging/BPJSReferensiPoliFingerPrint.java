 ...
 * @author dosen
 */
public final class BPJSReferensiPoliFingerPrint extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public BPJSReferensiPoliFingerPrint(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Referensi Poli FingerPrint BPJS ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSReferensiPoliFingerPrint dialog = new BPJSReferensiPoliFingerPrint(new javax.swing.JFrame(), true);
            ...
            if (nameNode.path("code").asText().equals("1")) {
                ...
                if (response.isArray()) {
                    for (JsonNode list : response) {
                        if (list.has("kodesubspesialis")) {
                            tabMode.addRow(new Object[] {
                                "Kode Sub Spesialis", ":",
                                list.path("kodesubspesialis").asText()
                            });
                        }
                        if (list.has("namasubspesialis")) {
                            tabMode.addRow(new Object[] {
                                "Nama Sub Spesialis", ":",
