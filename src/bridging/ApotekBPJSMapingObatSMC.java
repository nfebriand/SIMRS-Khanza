 ...
 * @author dosen
 */
public final class ApotekBPJSMapingObatSMC extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ApotekBPJSMapingObatSMC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            try {
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        Valid.exportHtmlSmc("MapingObatApotekBPJS.html", "Pencarian Referensi Kamar Aplicare", tbJnsPerawatan);
                        break;
                    case "Laporan 2 (WPS)":
                        Valid.exportWPSSmc("MapingObatApotekBPJS.wps", "Pencarian Referensi Kamar Aplicare", tbJnsPerawatan);
                        break;
                    case "Laporan 3 (CSV)":
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ApotekBPJSMapingObatSMC dialog = new ApotekBPJSMapingObatSMC(new javax.swing.JFrame(), true);
